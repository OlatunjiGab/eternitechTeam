...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="desc">{{ $role->display_name }}</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-1 actions">
			@if(LAFormMaker::la_access("Roles", "edit"))
			...
			@if(LAFormMaker::la_access("Roles", "delete"))
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.roles.destroy', $role->id], 'method' => 'delete', 'style'=>'display:inline', 'onsubmit'=>$deleteMessage]) }}
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						{!! LAFormMaker::display($module, 'parent') !!}
