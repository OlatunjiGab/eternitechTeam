	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="{{url(config('laraadmin.adminRoute') ."/modules", [0])}}" method="POST" id="module_del_form" style='display:inline'>
					{{method_field('DELETE')}}
					{{ csrf_field() }}
...
<div class="modal fade" id="AddFieldModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => '\Dwij\Laraadmin\Controllers\FieldController@store', 'id' => 'field-form']) !!}
