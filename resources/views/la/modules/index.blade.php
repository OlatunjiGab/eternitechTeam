...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => '\Dwij\Laraadmin\Controllers\ModuleController@store', 'id' => 'module-add-form']) !!}
...
<div class="modal" id="module_delete_confirm">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="{{url(config('laraadmin.adminRoute') ."/modules", [0])}}" method="POST" id="module_del_form">
					{{method_field('DELETE')}}
					{{ csrf_field() }}
