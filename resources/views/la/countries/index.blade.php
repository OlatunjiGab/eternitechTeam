...
@section("headerElems")
@if(LAFormMaker::la_access("Countries", "create"))
	<a href="{{ route(config('laraadmin.adminRoute').'.countries.create') }}" class="btn btn-success btn-sm pull-right">Add Country</a>
@endif
@endsection
