...
@section("headerElems")
@if(LAFormMaker::la_access("Employees", "create"))
	<a href="{{ route(config('laraadmin.adminRoute').'.employees.create') }}" class="btn btn-success btn-sm pull-right">Add Employee</a>
@endif
@endsection
