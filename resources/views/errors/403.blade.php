    ...
    <body>
        <div class="container">
            <div class="content">
                ...
                @if( Route::currentRouteName() == "admin.companies.index" || Route::currentRouteName() == "admin.partners.index" || Route::currentRouteName() == "admin.popup-content.index" )
                <div class="title">This option is for Premium Partner only.</div>
                @else
