...
chrome_local_alert: 'The built-in WebRTC engine in the web-phone will not work from local filesystem in Google Chrome or Opera browsers (only on HTTPS, from webservers with valid SSL certificate).\nIn these circumstances the web-phone will be forced to use the NS or other engines if available. You can use Firefox if you wish to test the web-phone WebRTC engine when launched from local file system.',
chrome_local_webrtc_audio: 'WebRTC does not have permission to access audio devices from local file system in Chrome and Opera browsers. \nThe web-phone must be hosted on a secure webserver (HTTPS) to be able to make/receive calls using WebRTC.',
chrome_https: 'For Chrome, Opera and Firefox version 68 and above, we recommend to host the web-phone on secure http (https), otherwise WebRTC will not work.',
...
only_webrtc_engine1: 'Only WebRTC engine is available in your browser but it is disabled in the web-phone with the enginepriority_webrtc parameter',
only_webrtc_engine2: 'Only WebRTC engine is available in your browser but it is disabled in the web-phone. Please contact your service provider.',
only_ns_engine1: 'Only Service plugin engine is available in your browser but it is disabled in the web-phone with the enginepriority_ns parameter',
only_ns_engine2: 'Only Service plugin engine is available in your browser but it is disabled in the web-phone. Please contact your service provider.',
...
only_app_engine1: 'Only App engine is available in your browser but it is disabled in the web-phone with the enginepriority_app parameter',
only_app_engine2: 'Only App engine is available in your browser but it is disabled in the web-phone. Please contact your service provider.',
...
sett_comment_enablepush: 'Listen for incoming calls also when the web-phone is not opened',
...
'technical support: <a href="mailto:web-phone@mizu-voip.com"web-phone@mizu-voip.comm</a>',
//TRANSLTEND
...
chrome_local_alert_hu: 'A web-phone nem fog müködni local filesystem-ről a Google Chrome és Opera böngészőkben. Csak webserverről fog müködni. Ha local filesystem-ről szeretnéd tesztelni, akkor használhatsz Firefox-ot vagy Internet Explorer-t.',
//OPSSTART
...
'<br />' +
'Contact <a href="mailto:web-phone@mizu-voip.com">web-phone@mizu-voip.com</a> for any help<br />' +
...
'<a href="https://www.mizu-voip.com" target="_blank" onclick="webphone_api.common.OpenLinkInInternalBrowser(\'https://www.mizu-voip.com\')">https://www.mizu-voip.com</a><br />' +
'general/commercial: <a href="mailto:info@mizu-voip.com">info@mizu-voip.com</a><br />' +
'technical support: <a href="mailto:web-phone@mizu-voip.com">web-phone@mizu-voip.com</a>',
...
chrome_local_webrtc_audio_hu: 'A WebRTCnek nincs jogosultsága, hogy hozzáférjen az audio eszközökhez egy lokális fájlrendszerrol a Chrome és Opera böngészokben. \nA web-phone egy biztonságos webszerveren kell legyen hosztolva (HTTPS), hogy müködjenek a bejövo és kimeno hivások WebRTC-n',
//chrome_https_hu: 'It is recommended to host the web-phone on HTTPS to enable WebRTC on Chrome / Opera',
//chrome_https_hu: 'For Chrome and Opera we recommend to host the web-phone on secure http (https), otherwise the mizu https proxy might be used.',
chrome_https_hu: 'A web-phone-nak a helyes müködésének érdekében ajánljuk, hogy hosztolják ezt egy biztonságos webszerveren (https), másképpen a hivások nem fognak müködni WebRTCn.',
webrtc_local_sipserver_hu: 'Lokális WebRTC szerver szükséges!', 
//chrome_https_reload_hu: 'For Chrome and Opera we recommend to host the web-phone on secure http (https).',
...
chrome_local_webrtc_audio_pt: 'O WebRTC não tem permissão para acessar dispositivos de áudio a partir do sistema de arquivos local em navegadores Chrome e Opera.\n O web-phone deve ser hospedado em um servidor web seguro (HTTPS) para ser capaz de fazer / receber chamadas usando WebRTC',
//chrome_https_pt: 'Recomenda-se instalar o web-phone em HTTPS para permitir WebRTC no Chrome / Opera',
//chrome_https_pt: 'Para Chrome e Opera recomendamos para hospedar o web-phone em http segura (https), caso contrário, o proxy https foneflex pode ser usado',
chrome_https_pt: 'Para Chrome e Opera recomendamos para hospedar o web-phone em http segura (https), caso contrário WebRTC não vai funcionar',
webrtc_local_sipserver_pt: 'Servidor WebRTC local necessário!',
//chrome_https_reload_pt: 'Para Chrome e Opera recomendamos hospedar o web-phone em http segura (https)',
