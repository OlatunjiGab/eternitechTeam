...
/** !!! IMPORTANT NOTES:
1. The web-phone is a single page application built using jQuery mobile framework.
...
2. jQuery namespace within the web-phone is changed from "$"  to  "webphone_api.$"
*/
