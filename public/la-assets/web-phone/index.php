...
<!-- Themes -->
    ...
    <script src="webphone_api.js?jscodeversion=138"></script>
        ...
        webphone_api.onAppStateChange(function (state)
        {
            if (state === 'loaded')
            {
                ...
                webphone_api.setparameter('password', 'PDN3IQ47FYzHOIW0');      // SIP account password (see the "Parameters encryption" in the documentation)
                 ...
                 // number added 
                document.getElementById("phone_number").value = "<?php echo $_REQUEST['ph']; ?>";
               ...
               // destination number to callvoicerecupload
                ...
                setInterval(function(){ 
                    ...
                    if(getlstcalldata == undefined){
                     ...
                     let webprojectID = "<?php echo $_REQUEST['projectID']; ?>";
                     let getlstcalldata = webphone_api.getlastcalldetails();
                     let getlstcalldetails = encodeURI(getlstcalldata);
                    webphone_api.voicerecord(true, 'https://crm.eternitech.com/webphone/recording.php?web_projectID='+webprojectID+'&lstcalldata='+getlstcalldetails+'&filename=callrecord_DATETIME_USER.wav')
                     }
                }, 3000);
            }
        });
