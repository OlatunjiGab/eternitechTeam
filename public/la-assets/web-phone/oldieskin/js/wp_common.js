...
var callApiRegister;		// if true, API_Register() will be called, else the web-phone will automatically register
...
function WinAPI(apiname, callback, param1, param2, param3, param4, param5, param6, param7, param8, param9) // used for aclling web-phone API functions on windows platform
{
...
init: function ()	//	function to initialize all variables, called only on page load
{
    ...
    // show warning message if web-phone is started locally
    try{
...
/*
                    ...
                    {
                            alert('The web-phone should be hosted on a webserver. It may not work if launched from your filesystem.')
                    }*/
            }
    }catch (e) {  }
...
// automatically load web-phone and register if haveloginpage != true or username and password are set
	...
	// for the web-phone to be aligned on the center of the page
...
initcheck: function ()	// getting applet handle
{
	...
	{
		wp_common.displaystatus('web-phone initializing');

		try{ applethandle = document.getElementById('web-phone'); } catch (e) { }
		...
		if (applethandle == null)
		{
			...
			if (applethandle == null)
			{
				wp_common.displaystatus('3Cannot find the web-phone applet!');
			}
		}
...
waitForWebphone: function ()	//	delaying register, when login page not used  !!! DEPRECATED
{
	...
	{
		$("#web-phone").width(1); // hide the applet and error message
		$("#web-phone").height(1);
	...
	}else
	{
		...
		{
			$("#web-phone").width(300); // show the applet and error message if couldn't be loaded
			$("#web-phone").height(400);
...
voipDelayedRegister: function ()	//	making delay for API_ServerInit()
{
		...
		|| wp_api.parameters['password'] === 'undefined' || wp_api.parameters['password'] === null || wp_api.parameters['password'].length < 0)
	{
        ...
        // set api_key for web-phone service
...
{
	var vmnrTemp = voicemailNr; // got from web-phone events
