...
*																												*
*	Always put the web-phone's html code in a <div> element with id="webphone_bg_container"						*																			*																												*
...
*	wp_api.ReceiveEvents() // Notifications (status updates, events, etc) are received from the web-phone		*
*																												*
...
// used for custom web-phone skins only
	...
	background_color: '',		// web-phone background color
	...
	webphone_width: 256,				// width of web-phone in pixels - don't specify measurement unit
	webphone_height: 408,
...
// used for both, custom web-phone skins and click 2 call
