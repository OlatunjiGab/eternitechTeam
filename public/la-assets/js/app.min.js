...
$(document).ready(function() {
    ...
    function getLI(upload) {
        ...
        return '<li><a class="fm_file_sel" data-toggle="" data-placement="top" title="'+upload.name+'" upload=\''+JSON.stringify(upload)+'\'>'+image+'</a></li>';
    }
    ...
    $(".btn_upload_files").on("click", function() {
        ...
        $('div .Switch.Ajax.Round').removeClass('Off');
        $('div .Switch.Ajax.Round').addClass('On');
    ...
    $("body").on("click", ".fm_file_sel", function() {
        ...
        if(type == "image") {
            ...
            $hinput.next("div.uploaded_files").append("<a class='uploaded_file2' upload_id='"+upload.id+"' target='_blank' href='"+bsurl+"/files/"+upload.hash+"/"+upload.name+"'>"+fileImage+"<i title='Remove File' class='remove-file-item fa fa-times'></i></a>");
        }
        $("#fm").modal('hide');
    });
});